 ...
 * As it turns out, we actually have two different forms of retpolines that
 * exist in the system:
 *
 *  1. A full retpoline
 *  2. A no-op version
 ...
 * XXX Factor this out so cpuid.c can be moved to intel/.
 */
int enable_platform_detection = 0;
